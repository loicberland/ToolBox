	...
	return []Action{
		...
		},
		{
			...
			Fields: []ActionField{
				...
				{Name: "workshop_id", Label: "Atelier ID", Type: "number", Required: true},
				...
				{Name: "target_name_auto_load", Label: "Cible chargement automatique", Type: "string", Default: ""},
				{Name: "is_job_name_auto", Label: "Nom dossier CN automatique", Type: "bool", Default: false},
				{Name: "job_name_auto_template", Label: "Template nom dossier CN", Type: "string", Default: ""},
				{Name: "job_name_auto_next_number", Label: "Prochain numéro dossier CN", Type: "number", Default: 0},
				{Name: "is_operator_instructions_displayed", Label: "Afficher instructions opérateur", Type: "bool", Default: false},
				{Name: "created_by", Label: "Créé par", Type: "number", Default: 1},
			},
		...
		},
		{
			...
			Fields: []ActionField{
				...
				{Name: "machine_group_ids", Label: "IDs groupes machine", Type: "number[]", Default: []any{}},
				{Name: "is_file_deletion_allowed", Label: "Suppression fichier autorisée", Type: "bool", Default: true, HiddenWhen: map[string]any{"dnc_port_type": "serial"}},
				{Name: "is_file_viewing_allowed", Label: "Visualisation fichier autorisée", Type: "bool", Default: true, HiddenWhen: map[string]any{"dnc_port_type": "serial"}},
				...
				{Name: "target_name_root", Label: "Cible racine", Type: "string", Default: "cible2", HiddenWhen: map[string]any{"dnc_port_type": "serial"}},
		...
		},
		{
			...
			Kind:        KindAPI,
			Products:    []string{GedixProdV10},
			Fields:      []ActionField{{Name: "lang", Label: "Langue", Type: "string", Default: "fr"}, {Name: "user_id", Label: "Utilisateur ID", Type: "number", Default: 1}},
		...
		},
		{
			...
			Fields: []ActionField{
				...
				{Name: "machine_group_ids", Label: "IDs groupes machine", Type: "number[]", Default: []any{}},
				{Name: "user_id", Label: "Utilisateur ID", Type: "number", Default: 1},
			},
