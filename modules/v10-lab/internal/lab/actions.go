	...
	return []Action{
		...
		},
		{
			...
			Fields: []ActionField{
				...
				{Name: "workshop_id", Label: "Atelier ID", Type: "number", Required: true, Default: 1},
		...
		},
		{
			...
			Fields: []ActionField{
				...
				{Name: "is_file_deletion_allowed", Label: "Suppression fichier autorisée", Type: "bool", Default: true, HiddenWhen: map[string]any{"dnc_port_type": "serial", "is_root_browsing_allowed": false}},
				{Name: "is_file_viewing_allowed", Label: "Visualisation fichier autorisée", Type: "bool", Default: true, HiddenWhen: map[string]any{"dnc_port_type": "serial", "is_root_browsing_allowed": false}},
				...
				{Name: "target_name_root", Label: "Cible racine", Type: "string", Default: "cible2", HiddenWhen: map[string]any{"dnc_port_type": "serial", "is_root_browsing_allowed": false}},
		...
		},
		{
			...
			Fields: []ActionField{
				...
				{Name: "machine_group_ids", Label: "IDs groupes machine", Type: "number[]", Default: []any{}, ItemMin: 1},
				{Name: "user_id", Label: "Utilisateur ID", Type: "number", Required: true, Default: 1},
			},
